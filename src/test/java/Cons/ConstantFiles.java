...
public class ConstantFiles {
	...
	public static final String SCREENSHOTS_FOLDER_PATH = ROOT_PATH+"/src/test/resources/Reports/"+CommonUtilities.getTimeStamp()+"Target.PNG";
	public static final String REPORTS_FILE_PATH = ROOT_PATH+"/src/test/resources/Reports/"+CommonUtilities.getTimeStamp()+"Target.html";
